package org.codeus.integration_test.messaging;

import org.codeus.integration_test.config.TestContainersConfig;
import org.codeus.integration_test.messaging.event.ExchangeCompletedEvent;
import org.codeus.integration_test.repository.AuditLogRepository;
...
import static org.codeus.integration_test.config.RabbitMQConfig.AUDIT_COMPLETED_ROUTING_KEY;
import static org.codeus.integration_test.config.RabbitMQConfig.AUDIT_EXCHANGE;
